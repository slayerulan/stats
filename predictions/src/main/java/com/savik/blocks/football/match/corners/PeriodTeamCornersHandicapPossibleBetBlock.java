...
public class PeriodTeamCornersHandicapPossibleBetBlock extends PossibleBetContainer<FootballMatch> {
    public PeriodTeamCornersHandicapPossibleBetBlock(MatchData homeMatchData, MatchData guestMatchData) {
        super(Arrays.asList(
