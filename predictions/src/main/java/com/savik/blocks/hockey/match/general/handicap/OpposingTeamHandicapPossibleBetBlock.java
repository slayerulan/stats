...
public class OpposingTeamHandicapPossibleBetBlock extends PossibleBetContainer<HockeyMatch> {
    public OpposingTeamHandicapPossibleBetBlock(MatchData homeMatchData, MatchData guestMatchData) {
        super(
                Arrays.asList(
