...
import com.savik.bets.general.other.PeriodTeamWinAndTotalOverPossibleBet;
    ...
    public PeriodTeamWinAndTotalOverPossibleBetBlock(MatchData homeMatchData, MatchData guestMatchData) {
        super(
                Arrays.asList(
                        ...
                        new PossibleBetContainer<>(
                                new PeriodTeamWinAndTotalOverPossibleBet<>(homeMatchData, guestMatchData, HockeyMatch.MATCH, 6.5),
