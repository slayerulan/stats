...
public class PeriodAnyWinAndTotalUnderPossibleBet<T extends Match> extends PossibleBet<T> {
    public PeriodAnyWinAndTotalUnderPossibleBet(Function<T, Period> function, double amount) {
        super(
