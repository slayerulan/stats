...
public class Book1xbetShortName {
    ...
    public static final String TEAM_WIN_AND_TOTAL_OVER_NO = "207";
    public static final String TEAM_WIN_AND_TOTAL_UNDER_YES = "196";
    public static final String TEAM_WIN_AND_TOTAL_UNDER_NO = "206";
    public static final String TEAM_NOT_LOOSE_AND_TOTAL_OVER_YES = "199";
    public static final String TEAM_NOT_LOOSE_AND_TOTAL_OVER_NO = "209";
    ...
    public static final String GOAL_BETWEEN_YES = "2949";
    public static final String GOAL_BETWEEN_NO = "2950";
