...
public class MatchParser {
    ...
    public static StatsInfoDto parseStats(Elements elements) {
        ...
        return StatsInfoDto.builder()
                    .homePossession(Integer.valueOf(possesionElement.parent().select(".fl").text().replaceAll("\\D+", "")))
                    .guestPossession(Integer.valueOf(possesionElement.parent().select(".fr").text().replaceAll("\\D+", "")))
                    .homeCorners(Integer.valueOf(cornersElement.parent().select(".fl").text().replaceAll("\\D+", "")))
                    .guestCorners(Integer.valueOf(cornersElement.parent().select(".fr").text().replaceAll("\\D+", "")))
                    ...
                    .homeFouls(Integer.valueOf(foulsElement.parent().select(".fl").text().replaceAll("\\D+", "")))
                    .guestFouls(Integer.valueOf(foulsElement.parent().select(".fr").text().replaceAll("\\D+", "")))
                    .homeOffsides(Integer.valueOf(offsidesElement.parent().select(".fl").text().replaceAll("\\D+", "")))
                    .guestOffsides(Integer.valueOf(offsidesElement.parent().select(".fr").text().replaceAll("\\D+", "")))
                    .build();

    }

    static Map<Integer, Who> parseGoals(Elements goalsDivs) {
        return goalsDivs
                .stream()
                .collect(Collectors.toMap(
                        i -> calculateTime(i),
                        i -> i.parent().parent().hasClass("fl") ? Who.HOME : Who.GUEST
                ));
    }
    ...
    static Map<Card, Who> parseCards(Elements goalsDivs) {
        return goalsDivs
                .stream()
                .collect(Collectors.toMap(
                        d -> Card
                                ...
                                .build(),
                        d -> d.parent().parent().hasClass("fl") ? Who.HOME : Who.GUEST
