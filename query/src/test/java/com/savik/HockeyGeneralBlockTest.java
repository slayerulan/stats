...
public class HockeyGeneralBlockTest {
    ...
    public void testTotalOver() {
        ...
        BetContainer totalOverBlock = generalBlock.findByType(TOTAL).findByType(TOTAL_OVER);
    ...
    public void testTotalUnder() {
        ...
        BetContainer totalUnderBlock = generalBlock.findByType(TOTAL).findByType(TOTAL_UNDER);
    ...
    public void testTeamTotalUnder() {
        ...
        BetContainer totalUnderBlock = generalBlock.findByType(TOTAL).findByType(TEAM_TOTAL_UNDER);
    ...
    public void testOtherTeamTotalOver() {
        ...
        BetContainer totalOverBlock = generalBlock.findByType(TOTAL).findByType(OPPOSING_TEAM_TOTAL_OVER);
    ...
    public void testOtherTeamTotalUnder() {
        ...
        BetContainer totalUnderBlock = generalBlock.findByType(TOTAL).findByType(OPPOSING_TEAM_TOTAL_UNDER);
    ...
    public void testFirstPeriodAnyWinner() {
        ...
        BetContainer block = generalBlock.findByType(FIRST_PERIOD).findByType(ANY_WIN);
    ...
    public void testLastGoalAfter() {
        ...
        BetContainer block = generalBlock.findByType(LAST_GOAL_AFTER);

        BetContainer after54 = block.findByType(OVER_54);
    ...
    public void testTeamNotLooseAndTotalOver() {
        ...
        BetContainer block = generalBlock.findByType(TEAM_NOT_LOOSE_AND_TOTAL_OVER);
    ...
    public void testTeamNotLooseAndTotalUnder() {
        ...
        BetContainer block = generalBlock.findByType(TEAM_NOT_LOOSE_AND_TOTAL_UNDER);
        ...
        BetContainer under5AndHalf = block.findByType(UNDER_5_5);
        assertEquals(12, under5AndHalf.getAnalyzedMatchesAmount().intValue());
        assertEquals(3, under5AndHalf.getSuccessfullyMatchesAmount().intValue());
        assertEquals(0, under5AndHalf.getSkippedMatchesAmount().intValue());
        assertEquals(25, under5AndHalf.getPercentage().intValue());
    ...
    public void testOpposingTeamWinAndTotalUnder() {
        ...
        BetContainer block = generalBlock.findByType(OPPOSING_TEAM_WIN_AND_TOTAL_UNDER);

        BetContainer under4AndHalf = block.findByType(UNDER_4_5);
        assertEquals(12, under4AndHalf.getAnalyzedMatchesAmount().intValue());
        assertEquals(0, under4AndHalf.getSuccessfullyMatchesAmount().intValue());
        assertEquals(0, under4AndHalf.getSkippedMatchesAmount().intValue());
        assertEquals(0, under4AndHalf.getPercentage().intValue());
    ...
    public void testOpposingTeamNotLooseAndTotalOver() {
        ...
        BetContainer block = generalBlock.findByType(OPPOSING_TEAM_NOT_LOOSE_AND_TOTAL_OVER);
    ...
    public void testOpposingTeamNotLooseAndTotalUnder() {
        ...
        BetContainer block = generalBlock.findByType(OPPOSING_TEAM_NOT_LOOSE_AND_TOTAL_UNDER);

        BetContainer under4AndHalf = block.findByType(UNDER_4_5);
        assertEquals(12, under4AndHalf.getAnalyzedMatchesAmount().intValue());
        assertEquals(2, under4AndHalf.getSuccessfullyMatchesAmount().intValue());
        assertEquals(0, under4AndHalf.getSkippedMatchesAmount().intValue());
        assertEquals(16, under4AndHalf.getPercentage().intValue());
    ...
    public void testTeamTotalOverAllPeriods() {
        ...
        BetContainer block = generalBlock.findByType(TEAM_TOTAL_OVER_ALL_PERIODS);

        BetContainer over0AndHalf = block.findByType(OVER_0_5);
        assertEquals(12, over0AndHalf.getAnalyzedMatchesAmount().intValue());
        assertEquals(3, over0AndHalf.getSuccessfullyMatchesAmount().intValue());
        assertEquals(0, over0AndHalf.getSkippedMatchesAmount().intValue());
        assertEquals(25, over0AndHalf.getPercentage().intValue());
    ...
    public void testOpposingTeamTotalOverAllPeriods() {
        ...
        BetContainer block = generalBlock.findByType(OPPOSING_TEAM_TOTAL_OVER_ALL_PERIODS);
    ...
    public void testOpposingTeamWinAtLeastNPeriods() {
        ...
        BetContainer block = generalBlock.findByType(OPPOSING_TEAM_WIN_AT_LEAST_N_PERIODS);
    ...
    public void testDrawAtLeastNPeriods() {
        ...
        BetContainer block = generalBlock.findByType(DRAW_AT_LEAST_N_PERIODS);
    ...
    public void testShotsOnTargetOver() {
        ...
        BetContainer over59AndHalf = block.findByType(OVER_59_5);
        assertEquals(12, over59AndHalf.getAnalyzedMatchesAmount().intValue());
        assertEquals(6, over59AndHalf.getSuccessfullyMatchesAmount().intValue());
        assertEquals(0, over59AndHalf.getSkippedMatchesAmount().intValue());
        assertEquals(50, over59AndHalf.getPercentage().intValue());
